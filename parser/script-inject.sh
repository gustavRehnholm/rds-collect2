...
touch stdout-dir/output-inject-ittr-220.txt
...
script -q -c "python3 inject-ittr.py 220" /dev/null | tee stdout-dir/output-inject-ittr-220.txt
...
script -q -c "python3 inject-rnd.py 220" /dev/null  | tee stdout-dir/output-inject-rnd-220.txt
