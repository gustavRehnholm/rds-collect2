...
./df-fitness.py -d rds-collect2/parser/injected-datasets/twitch/parsedFiles-itr-658 --train --constant -s 100 --csv wf-result/df-constant-twitch-itr-658.csv
...
./df-fitness.py -d rds-collect2/parser/injected-datasets/twitch/parsedFiles-rnd-658 --train --constant -s 100 --csv wf-result/df-constant-twitch-rnd-658.csv
...
./df-fitness.py -d rds-collect2/parser/injected-datasets/twitch/parsedFiles-itr-658 --train --tiktok -s 100 --csv wf-result/df-tiktok-twitch-itr-658.csv
...
./df-fitness.py -d rds-collect2/parser/injected-datasets/twitch/parsedFiles-rnd-658 --train --tiktok -s 100 --csv wf-result/df-tiktok-twitch-rnd-658.csv
